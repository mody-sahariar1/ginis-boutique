...
# category, name, size, material, price, qty, image, featured, description, [original_price/MRP]
CATALOG = [
    # ---------------- Sarees ----------------
...
def image_path(rel):
    # store the served URL so templates can use it directly
...
with app.app_context():
    ...
    if Product.query.count() == 0:
        ...
        print(f"Added {len(CATALOG)} products across the opening collection.")
    else:
